  ...
  return (
    <header className="Header_header__r9N9Y">
      ...
      <div className="Header_header__inner__nfTZS">
        ...
        <nav className="Header_menu__Yr6mh">
          ...
          <div className="Header_menu__list__h_Anx Header_menu__list--twin__w_0Lp" style={{ transform: 'none', transformOrigin: '50% 50% 0px' }}>
            ...
            <div className="Header_menu__hover-pill__NFAxL" style={{ position: 'relative', gridColumn: 1, borderRadius: '100px', transform: 'none', transformOrigin: '50% 50% 0px', left: '0px' }}></div>
      ...
      <div className="Header_face__r0io3">
        <div style={{ transformOrigin: 'center top', transform: 'rotate(0deg) translateZ(0px)' }}>
          <div style={{ opacity: 1, transform: 'translateY(-50%) translateZ(0px)' }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 40 40" className="" style={{ '--width': 40, '--height': 40 }}>
